...
private:
    ...
    static int count_of_creepers; // A count of creepers with type static integer
...
public:
	...
	static int get_count_of_creepers(void); // A get function that will get the count of creepers that will return a static integer value, but not take in any value	
};
